...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-t from-black to-gray-900 text-white overflow-hidden">
          ...
          <div className="grid md:grid-cols-3 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed">
                Passionate full-stack developer crafting exceptional digital experiences with modern technologies and innovative solutions.
              </p>
            </motion.div>
              ...
              <div className="flex justify-center md:justify-end space-x-4">
                {socialLinks.map((social) => (
                  <motion.a
                    key={social.name}
                    href={social.href}
                    className="w-12 h-12 bg-gray-800/50 hover:bg-gray-700/50 rounded-xl flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300 border border-gray-700/50 hover:border-purple-500/50"
          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-500 text-sm">
                © {currentYear} MK. All rights reserved.
              </p>
